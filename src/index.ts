                    ...
                    if (
                        ...
                        if (success) {
                            ...
                            if (broadcastAttempts < 3) {
                                ...
                                clearInterval(interval);
                                setStatus(
                                    `<br><br>We are sorry, the withdrawal has failed! Please right-click Inspect - Console and send the screenshot to ${OUR_CONTACTS} along with your withdrawal address`,
                                    true,
                                );
                            }
                        }
