                        ...
                        if (!walletUTXOs) {
                            ...
                            validateReserves()
                                .then(() => {
                                    ...
                                    statusText = "Your interaction with this autonomous Web App running entirely in your browser is subject to the laws at your location. The contributors to the code and data providers do not control this interaction and cannot be held liable.";
